...
Two other things live on the same Settings > Profile screen but are covered elsewhere, since they're a different job from editing your public profile: copying your raw key again is in [Backing Up and Recovering Your Account](/articles/backing-up-and-recovering-your-account), and clearing or deleting your profile entirely is in [Can I Delete My Account or Data?](/articles/deleting-your-account).
