...
Chat moves fast. Even the best-organized [rooms](/articles/spaces-and-rooms-explained) bury useful things under new messages within a day. Flotilla gives organizers two tools built to fight that: **Featured Content**, which surfaces a handful of important items on your space's About page, and the **Library**, a searchable collection of pinned links and events that sticks around indefinitely. Neither replaces chat. They sit alongside it as the "start here" and "keep this handy" layers of your space.
...
Editing Featured Content is part of the same space-editing surface covered in [Managing a Space](/articles/managing-a-space): your relay needs to support Nostr's relay management API, and you need admin permission on the space. Without both, the option to feature content won't appear. Once you have access, you edit featured items from the same flow you'd use to update your space's name, description, or icon.
