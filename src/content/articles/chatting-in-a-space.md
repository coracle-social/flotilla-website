...
Once you've [joined a space](/articles/joining-a-space), most of your time there happens in its rooms — the channels described in [Spaces and Rooms Explained](/articles/spaces-and-rooms-explained). Text rooms work like real-time chat: pick one from the navigation, type in the composer at the bottom, and hit send. This article covers the everyday mechanics of posting and interacting with messages once you're inside.
...
- **Mention** another member by name to get their attention directly. Depending on their [notification settings](/articles/notifications-and-muting), a mention can trigger a notification for them.
...
Chat in rooms is just one layer of what a space offers — see [Spaces and Rooms Explained](/articles/spaces-and-rooms-explained) for the bigger picture, including threads, the calendar, and the library. To talk to someone one-on-one instead of in a room, see [Direct Messages](/articles/direct-messages). If a room gets too loud, [Notifications and Muting](/articles/notifications-and-muting) covers how to tune what pings you or mute it entirely. And to tip someone for a great message, see [Zaps and Your Wallet](/articles/zaps-and-wallet).
